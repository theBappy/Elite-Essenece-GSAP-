...
interface FragnanceDocumentData {
  ...
  /**
   * Sent Profile field in *Fragnance*
   *
   * - **Field Type**: Select
   * - **Placeholder**: *None*
   * - **Default Value**: spicy
   * - **API ID Path**: fragnance.sent_profile
   * - **Tab**: Main
   * - **Documentation**: https://prismic.io/docs/fields/select
   */
  sent_profile: prismic.SelectField<"spicy" | "woody" | "fresh", "filled">;
...
export interface ProductFeatureSliceDefaultPrimary {
  ...
  /**
   * Fragnance field in *ProductFeature → Default → Primary*
   *
   * - **Field Type**: Content Relationship
   * - **Placeholder**: *None*
   * - **API ID Path**: product_feature.default.primary.fragnance
   * - **Documentation**: https://prismic.io/docs/fields/content-relationship
   */
  fragnance: prismic.ContentRelationshipField<"fragnance">;
}
